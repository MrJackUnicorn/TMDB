...
class ApiClient {
  ...
  static const _apiKey = 'bd42b603b0894f02f3faec1d75cd457c';
  ...
  Future<TrendingResponse> tranding(
      String mediaType, String timeWindow, String locale, int page) async {
    parser(dynamic json) {
      final jsonMap = json as Map<String, dynamic>;
      final response = TrendingResponse.fromJson(jsonMap);
      return response;
    }
